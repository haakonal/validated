# Validated: Data Validation & Constraint Engine
...
#### A. [src/validated/validators/](api/validators.md)
...
#### B. [src/validated/decorator.py](api/core.md)
...
This is demonstrated in [src/satellite/validation.py](api/satellite.md) via `validate_subsystem_diagnostics`.
...
### Subsystem Models ([src/satellite/models.py](api/satellite.md))
...
### Subsystem Telemetry Validation ([src/satellite/validation.py](api/satellite.md))
...
> **Note**: For a complete reference on database schemas, secure serialization, and how to implement a `ValidatorProvider`, see [DATABASE_DESIGN.md](database.md).
